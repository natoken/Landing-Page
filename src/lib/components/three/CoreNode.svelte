<script>
	...
	// Load the logo SVG with brand color baked in
	if (typeof window !== 'undefined') {
		const svgStr = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" width="512" height="512">
<defs>
...
<g stroke="url(#sg)" stroke-width="8" stroke-linejoin="round" stroke-linecap="round" fill="none">
...
{#if logoTexture}
	<T.Mesh position={[core.position[0], core.position[1], core.position[2] + 0.01]} renderOrder={3}>
...
<!-- Opaque core mask — hides hex lines passing through center -->
<T.Mesh position={core.position} renderOrder={1}>
...
<!-- Outer glow halo -->
<T.Mesh position={core.position} renderOrder={2}>
